...
const Button = ({
  ...
  return (
    <div>
      ...
      >
        Edit
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="inline-block w-4 h-5 ml-4 mb-2 hover:rotate-180 transition duration-500">
