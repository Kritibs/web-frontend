  ...
  return (
    <div className=''>
      ...
      <h2 className='text-center sm:text-left px-4'>
        ...
        created with the help of a Notary.
        <br></br>
        <br></br>
        ...
        among its many uses. Country refers to the United States. Device means
        any device that can access this Service such as a computer (personal or
        desktop), a cellphone or a digital tablet. Personal Data is any
        ...
        analyzing how the Service is used. Third-party Social Media Service
        refers to any website or any social network website through which a User
        can log in or create an account to use the Service. Usage Data refers to
        ...
        a page visit). Website refers to Luther Marketplace, accessible from
        lcmarketplace.vercel.app/shop. You means the individual accessing or using
        ...
        article. With Service Providers: We may share Your personal information
        ...
        Our business to another company. With Affiliates: We may share Your
        ...
        all users and may be publicly distributed outside. If You interact with
        ...
        with You and view Your profile. With Your consent: We may disclose Your
        personal information for any other purpose with Your consent. Retention
        of Your Personal Data The Company will retain Your Personal Data only
        ...
        including the security of Your data and other personal information. You
        ...
        obligation or lawful basis to do so. If the Company is involved in a
        ...
        transferred and becomes subject to a different Privacy Policy. Under
        ...
        that such action is necessary to comply with a legal obligation. Our
