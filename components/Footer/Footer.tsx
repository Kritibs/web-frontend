...
export default function Footer() {
  return (
    <div className="h-64 lg:h-56 px-6">
      <div className="grid grid-rows-2 gap-6">
        ...
        <div className="flex space-x-6 flex-col border-t border-gray">
          <PrivacyCopyright />
        </div>
      </div>
    </div>
  ...
  return (
    <>
      ...
      <div className="text-center mt-2">
        &#169; Copyright 2023 Luther Marketplace. All rights reserved.
      </div>
    </>
  );
}
